...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/assets/css/lib/animate.css">
      ...
      <div class="main">
        ...
        <ul class="menu">
          ...
          <li><a href="#">Serviços</a>
            <ul class="dropdown">
              <li><a href="<?php echo get_permalink('7'); ?>">Produção Web</a></li>
              <li><a href="<?php echo get_permalink('9'); ?>">Design Gráfico</a></li>
              <li><a href="<?php echo get_permalink('11'); ?>">Impressão</a></li>
          ...
          <li><a href="http://loja.rovedo.com.br" target="_blank">Loja</a></li>
