...
?>
    ...
    <div class="topo-internas inteiro" style="background: url('<?php echo $background['url']; ?>') fixed no-repeat;">
      <div class="main">
    ...
    <?php endwhile; ?>
      ...
      <hr>
      <div class="servicos-item1" style=" background: url('<?php bloginfo('template_url'); ?>/assets/imagens/img.web.png') center no-repeat;">
        <div class="main">
      ...
      <div class="servicos-item3">
        <div class="main">
          ...
          <img src="<?php bloginfo('template_url'); ?>/assets/imagens/img-web-3.png">
        </div><!-- FIM .main -->
      ...
      <div class="orcamento left">
        <div class="main">
            ...
            <?php query_posts('posts_per_page=1') ?>
              ...
              <?php echo do_shortcode('[contact-form-7 id="92" title="Web"]'); ?>
            <?php endwhile; ?>
